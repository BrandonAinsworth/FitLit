...
describe('User', () => {
  ...
  // it('should calculate hours slept each day over the course of any given week', () => {});
  
  // it('should calculate sleep quality each day over the course of any given week', () => {});
